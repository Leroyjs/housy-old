...
<main>
  <section style="background-color: black">
    ...
    <button
      class="button button_type_svg button_color_white-outline button_size_svg-lg">
      <svg viewBox="0 0 29 23">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M27.9 11.5 17.5 1.1M1 11.5H28 1Zm26.8 0L17.5 21.9l10.4-10.4Z"/>
      </svg>
    ...
    <button
      class="button button_type_svg button_color_orange-outline button_size_svg-small">
    ...
    <div class="first-section__slider-nav slider-nav">
      ...
      <a href="" class=" button button_type_svg button_color_orange-outline">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
          ...
          <path
            d="M16.885 9.99998L11.53 4.64498M3.11499 9.99998L16.885 9.99998L3.11499 9.99998ZM16.885 9.99998L11.53 15.355L16.885 9.99998Z"
        ...
        <section class="snip">
            <div class="info-block">
                <div class="main-column-width snip__main-column sub-height main-padding-horizontal">
                    <div class="snip__text-arrow text-arrow text-arrow_color_orange-2">
                        <a href="" class="text-arrow__inner text-arrow__inner_rotate">
                            ...
                            <div class="text-arrow__text text_color_orange-2 text_size_small text_weight_bold">о компании</div>
                        </a>
                    </div>
                    <div>
                        ...
                        <div class="snip__desc text text_size_main text_color_white">
                            По замыслу создателей, HYGGE — это посёлок, в котором живут свободные люди. Свободные от стереотипов, свободные в проявлении чувств и эмоций. Люди, которые умеют наслаждаться каждым моментом и ценить
                        </div>
...
=======
      <svg width="24" height="71" viewBox="0 0 24 71" fill="none"
           xmlns="http://www.w3.org/2000/svg">
        <path d="M12 10L12 68M12 68L5 61M12 68L19 61" stroke="white"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </a>
  </section>
  <section class="snip">
    <div class="info-block">
      <div
        class="main-column-width snip__main-column sub-height main-padding-horizontal">
        <div class="snip__text-arrow text-arrow">
          <a href="" class="text-arrow__inner text-arrow__inner_rotate">
            <svg class="text-arrow__arrow" width="24" height="24"
                 viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
              <path d="M21 12L14 5M3 12L21 12L3 12ZM21 12L14 19L21 12Z"
                    stroke="#e76100" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round"/>
            </svg>
            <div
              class="text-arrow__text text_color_orange-2 text_size_small text_weight_bold">
              о компании
>>>>>>> 56d162e273e16ee45dab829422efeabc8a94fb0e
            </div>
          </a>
        </div>
        <div>
          ...
          <a href=""
             class="snip__arrow button button_type_svg button_color_white-outline button_size_svg-lg text_color_white text_size_main-lg">
            <svg viewBox="0 0 29 23">
  ...
  <section class="expertise info-block sub-height">
    <div class="main-column-width expertise__main-column">
...
=======
    ...
    <div class="sub-column-width expertise__sub-column main-padding-horizontal">
      ...
      <div class="expertise__desc text text_color_white text_size_main">
        Компания ИНСЛИ Недвижимость создает проекты, в которых простор и свобода
        соединяются с комфортом и безопасностью, образуя точки роста нового
        поколения людей.
      </div>
    </div>
  </section>
